...
class MedicoRepositoryTest {
    ...
    void seleccionarMedicoConEspecialidadEnFechaEscenario1() {
        var proximoLunes10H = LocalDate.now()
                .with(TemporalAdjuster.next(DayOfWeek.MONDAY)).atTime(10,0);
    ...
    private  Medico registrarMedico (String nombre, String email, String telefono, String dni, Especialidad especialidad ){
        var medico = new Medico(new datosMedico(nombre, email, telefono, dni, especialidad));
        em.persist(medico);
        return  medico;
    }
    ...
    private DatosDireccion datosDireccion(){
        return new DatosDireccion("loca",
                "azul",
                "Acapulco",
                "321",
                "12"
